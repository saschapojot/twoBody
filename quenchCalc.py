from quenchFuncs import *



def quenchCoef(t):
    m=int(np.floor(2*t/Tq))
    if m%2==0:
        return 0
    else:
        return B1
...
quenchHop=[[1,j,(j+1)%N] for j in range(0,N)]
dynamicPart=[["+-",hopDynPM,delta,[]],["-+",hopDynMP,delta,[]],
             ["+-",quenchHop,quenchCoef,[]],["-+",quenchHop,quenchCoef,[]],
             ["n",stgPot,D,[]]]
...
plt.plot(tPumpingValsAll,drift,color="black")
